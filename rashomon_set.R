rashomon_set <- function(dataset, epsilon = 0.05, seed = TRUE) {
  # data: data set from OpenML
  # bi, re, v: forester arguments
  # e: epsilon for rashomon set
  # returns ambiguity, discrepancy, rashomon size and best accuracy of the data set
